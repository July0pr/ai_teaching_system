...
class AIPPT():
    ...
    def createPptByOutline(self, outline):
        ...
        body = {
            ...
            "author": "王老师",  # PPT作者名：用户自行选择是否设置作者名
...
def ppt_llm(text):
    # 控制台获取
    # APPId = "b37adc31"
    # APISecret = "YTA4ZWQ1ZDhkMDQyZTYwZjc0NTBmYWUw"

    APPId = "e54486ca"
    APISecret = "MzdjYjg2YzNhYzY0NDQ2YWU3MTdhMmY3"
    # 查询PPT主题列表
    ...
    with open(f'D:/项目与竞赛/深度学习与人工智能/agent_all/data/PPT/{timestamp}.pptx', "wb") as file:
        for chunk in response.iter_content(chunk_size=1024):
            if chunk:
                file.write(chunk)

    return f'D:/项目与竞赛/深度学习与人工智能/agent_all/data/PPT/{timestamp}.pptx'
    # 储存到本地


if __name__ == '__main__':
    ppt_llm("生成读书分享报告")
    store_ppt(ppt_llm("生成读书分享报告"),"读书分享报告")
